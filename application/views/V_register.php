                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="<?= base_url('C_auth/register'); ?>">
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="nip" name="nip" placeholder="NIP" required autocomplete="off">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="nama" name="nama" placeholder="Nama Lengkap" required autocomplete="off">
                                </div>
                                <!-- <div class="form-group">
