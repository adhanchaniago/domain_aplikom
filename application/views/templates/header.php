...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url() . 'vendor/assets/img/logoprovjateng.ico' ?>">
    ...
    <link href="<?php echo base_url() . 'vendor/css/sb-admin-2.css' ?>" rel="stylesheet">
